        ...
        wp_localize_script(
            ...
            [
                ...
                'strings' => [
                    ...
                    'resumeRunning'    => __( 'Previous bulk in progress (started %1$s ago, %2$s of %3$s processed).', 'compressly' ),
                    'resumePaused'     => __( 'Previous bulk is paused (started %1$s ago, %2$s of %3$s processed).', 'compressly' ),
                    'agoMinute'        => __( '%d minute', 'compressly' ),
                    'agoMinutes'       => __( '%d minutes', 'compressly' ),
                    'agoHour'          => __( '%d hour', 'compressly' ),
                    'agoHours'         => __( '%d hours', 'compressly' ),
                    'agoSeconds'       => __( '%d seconds', 'compressly' ),
                ],
            ]
        );
    }
